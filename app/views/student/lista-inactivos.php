...
<div class="card Lista">
    ...
    <button type="submit" class="btn cambio1">Activar Estudiante</button>
...
<nav aria-label="...">
    <ul class="pagination pagination-sm">
        ...
        <li class="page-item"><a class="page-link" href="index.php?route=inactive-list">2</a></li>
        <li class="page-item"><a class="page-link" href="index.php?route=inactive-list">3</a></li>
    </ul>
</nav>