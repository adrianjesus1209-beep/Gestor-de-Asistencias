...
<div class="card Lista">
    ...
    <button type="submit" class="btn cambio1">Cambiar a Inasisistente</button>
...
<nav aria-label="...">
    <ul class="pagination pagination-sm">
        ...
        <li class="page-item"><a class="page-link" href="index.php?route=attendance-list">2</a></li>
        <li class="page-item"><a class="page-link" href="index.php?route=attendance-list">3</a></li>
    </ul>
</nav>