    ...
    <div class="row g-5">
        <div class="col-md-3">
            <div class="envoltorio-avatar-heroe mb-4">
                <img src="<?= BASE_URL ?>/assets/img/heroes/<?= $heroe['imagen'] ?>" class="avatar-heroe" alt="<?= $heroe['nombre'] ?>">
            </div>
            
            <div class="ps-1 mt-4">
                <div class="text-muted small text-uppercase fw-bold mb-1" style="letter-spacing: 1px;">Cronologia</div>
                <div class="text-dark small fw-bold text-uppercase" style="font-size: 11px;"><?= $heroe['nacimiento'] ?></div>
                <div class="text-dark small fw-bold text-uppercase" style="font-size: 11px;"><?= $heroe['fallecimiento'] ?></div>
            </div>
        </div>

        <div class="col-md-9 border-start ps-lg-5">
            <div class="mb-5">
                <h1 class="display-3 fw-bold text-dark mb-1"><?= $heroe['nombre'] ?></h1>
                <div class="fs-4 text-primary fw-medium mb-5"><?= $heroe['titulo'] ?></div>
            ...
            <div class="pt-5 mt-4 border-top">
                <a href="index.php" class="text-decoration-none text-dark small fw-bold text-uppercase" style="letter-spacing: 2px; opacity: 0.6;">
                    <i class="bi bi-chevron-left me-2"></i>Regresar a la Galeria
                </a>
            </div>
        </div>
    </div>
